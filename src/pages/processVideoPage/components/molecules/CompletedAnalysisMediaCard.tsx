  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* Estimated 이미지 개수 표시 */}
        {mediaSet.analysisJob.estimatedImageUrls && mediaSet.analysisJob.estimatedImageUrls.length > 0 && (
          <div className="mt-3 text-xs text-gray-500 flex items-center">
            ...
            자세 오버레이 {mediaSet.analysisJob.estimatedImageUrls?.length || 0}개
          </div>
        )}
      </div>
    </div>
