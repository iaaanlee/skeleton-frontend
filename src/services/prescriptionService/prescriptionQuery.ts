...
export const usePrescriptionHistory = (accountId: string, profileId: string) => {
  return useQuery({
    queryKey: [...QUERY_KEYS.prescriptions, 'history', accountId, profileId],
    queryFn: () => prescriptionService.getPrescriptionHistory(accountId, profileId),
